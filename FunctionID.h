...
istSEnumBlock(FunctionID,
    ...
    istSEnum(FID_addPotisionXCP),
    istSEnum(FID_erasePotisionXCP),
    istSEnum(FID_setPotisionXCP),
    istSEnum(FID_addPotisionYCP),
    istSEnum(FID_erasePotisionYCP),
    istSEnum(FID_setPotisionYCP),
