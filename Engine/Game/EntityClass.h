#ifndef atm_Engine_Game_EntityClass_h
#define atm_Engine_Game_EntityClass_h
...
istSEnumBlock(EntityClassID,
    ...
    istSEnum(EC_Zab),
    istSEnum(EC_RollerParts),
    istSEnum(EC_TriRollerSmall),
    istSEnum(EC_TriRollerLarge),
    istSEnum(EC_PentaRoller),
...
#ifndef atm_Engine_Game_EntityClass_detail
#define atm_Engine_Game_EntityClass_detail
...
#endif // atm_Engine_Game_EntityClass_detail

} // namespace atm
#endif //atm_Engine_Game_EntityClass_h
