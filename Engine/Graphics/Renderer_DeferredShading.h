#ifndef atm_Engine_Graphics_Renderer_DeferredShading_h
#define atm_Engine_Graphics_Renderer_DeferredShading_h
namespace atm {
...
#endif // atm_Engine_Graphics_Renderer_DeferredShading_h
