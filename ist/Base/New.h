...
#define AT_NEW(Type)                    new(stl::get_default_allocator(NULL)->allocate(sizeof(Type)))
#define AT_ALIGNED_NEW(Type, Align)     new(stl::get_default_allocator(NULL)->allocate(sizeof(Type), Align, 0))
