...
struct VC_Fn1
{
    ...
    {
        r=f(const_cast<A0T&>(a0.cast<A0T>()));
    }
    void operator()(F f, const VA0 &a0)
    {
...
struct VC_MemFn1
{
    ...
    {
        r=(o.*f)(const_cast<A0T&>(a0.cast<A0T>()));
    }
    void operator()(F f, C &o, const VA0 &a0)
    {
...
struct VC_ConstMemFn1
{
    ...
    void operator()(F f, const C &o, const VA0 &a0)
    {
        (o.*f)(const_cast<A0T&>(a0.cast<A0T>()));
    }
};
...
struct VC_Fn2
{
    ...
    {
        r=f(const_cast<A0T&>(a0.cast<A0T>()), const_cast<A1T&>(a1.cast<A1T>()));
    }
    void operator()(F f, const VA0 &a0, const VA1 &a1)
    {
...
struct VC_MemFn2
{
    ...
    {
        r=(o.*f)(const_cast<A0T&>(a0.cast<A0T>()), const_cast<A1T&>(a1.cast<A1T>()));
    }
    void operator()(F f, C &o, const VA0 &a0, const VA1 &a1)
    {
...
struct VC_ConstMemFn2
{
    ...
    void operator()(F f, const C &o, const VA0 &a0, const VA1 &a1)
    {
        (o.*f)(const_cast<A0T&>(a0.cast<A0T>()), const_cast<A1T&>(a1.cast<A1T>()));
    }
};
...
struct VC_Fn3
{
    ...
    {
        r=f(const_cast<A0T&>(a0.cast<A0T>()), const_cast<A1T&>(a1.cast<A1T>()), const_cast<A2T&>(a2.cast<A2T>()));
    }
    void operator()(F f, const VA0 &a0, const VA1 &a1, const VA2 &a2)
    {
...
struct VC_MemFn3
{
    ...
    {
        r=(o.*f)(const_cast<A0T&>(a0.cast<A0T>()), const_cast<A1T&>(a1.cast<A1T>()), const_cast<A2T&>(a2.cast<A2T>()));
    }
    void operator()(F f, C &o, const VA0 &a0, const VA1 &a1, const VA2 &a2)
    {
...
struct VC_ConstMemFn3
{
    ...
    void operator()(F f, const C &o, const VA0 &a0, const VA1 &a1, const VA2 &a2)
    {
        (o.*f)(const_cast<A0T&>(a0.cast<A0T>()), const_cast<A1T&>(a1.cast<A1T>()), const_cast<A2T&>(a2.cast<A2T>()));
    }
};
...
struct VC_Fn4
{
    ...
    {
        r=f(const_cast<A0T&>(a0.cast<A0T>()), const_cast<A1T&>(a1.cast<A1T>()), const_cast<A2T&>(a2.cast<A2T>()), const_cast<A3T&>(a3.cast<A3T>()));
    }
    void operator()(F f, const VA0 &a0, const VA1 &a1, const VA2 &a2, const VA3 &a3)
    {
...
struct VC_MemFn4
{
    ...
    {
        r=(o.*f)(const_cast<A0T&>(a0.cast<A0T>()), const_cast<A1T&>(a1.cast<A1T>()), const_cast<A2T&>(a2.cast<A2T>()), const_cast<A3T&>(a3.cast<A3T>()));
    }
    void operator()(F f, C &o, const VA0 &a0, const VA1 &a1, const VA2 &a2, const VA3 &a3)
    {
...
struct VC_ConstMemFn4
{
    ...
    void operator()(F f, const C &o, const VA0 &a0, const VA1 &a1, const VA2 &a2, const VA3 &a3)
    {
        (o.*f)(const_cast<A0T&>(a0.cast<A0T>()), const_cast<A1T&>(a1.cast<A1T>()), const_cast<A2T&>(a2.cast<A2T>()), const_cast<A3T&>(a3.cast<A3T>()));
    }
};
...
{ VC_ConstMemFn1<R,C,A0,4,SA0>()(f, o, a0); }

template<class R, class C, class A0, size_t SA>
inline void VariantCall(R (C::*f)(A0) const, const C &o, const TVariant<SA> *va)
{ VC_ConstMemFn1<R,C,A0,4,SA>()(f, o, va[0]); }
...
{ VC_ConstMemFn2<R,C,A0,A1,4,SA0,SA1>()(f, o, a0, a1); }

template<class R, class C, class A0, class A1, size_t SA>
inline void VariantCall(R (C::*f)(A0,A1) const, const C &o, const TVariant<SA> *va)
{ VC_ConstMemFn2<R,C,A0,A1,4,SA,SA>()(f, o, va[0], va[1]); }
...
{ VC_MemFn3<R,C,A0,A1,A2,4,SA0,SA1,SA2>()(f, o, a0, a1, a2); }
...
{ VC_MemFn3<R,C,A0,A1,A2,4,SA,SA,SA>()(f, o, va[0], va[1], va[2]); }
...
{ VC_ConstMemFn3<R,C,A0,A1,A2,4,SA0,SA1,SA2>()(f, o, a0, a1, a2); }

template<class R, class C, class A0, class A1, class A2, size_t SA>
inline void VariantCall(R (C::*f)(A0,A1,A2) const, const C &o, const TVariant<SA> *va)
{ VC_ConstMemFn3<R,C,A0,A1,A2,4,SA,SA,SA>()(f, o, va[0], va[1], va[2]); }
...
{ VC_Fn4<R,A0,A1,A2,A3,4,SA0,SA1,SA2,SA3>()(f, a0, a1, a2, a3); }
...
{ VC_Fn4<R,A0,A1,A2,A3,4,SA,SA,SA,SA>()(f, va[0], va[1], va[2], va[3]); }
...
{ VC_MemFn4<R,C,A0,A1,A2,A3,4,SA0,SA1,SA2,SA3>()(f, o, a0, a1, a2, a3); }
...
{ VC_MemFn4<R,C,A0,A1,A2,A3,4,SA,SA,SA,SA>()(f, o, va[0], va[1], va[2], va[3]); }
...
{ VC_ConstMemFn4<R,C,A0,A1,A2,A3,4,SA0,SA1,SA2,SA3>()(f, o, a0, a1, a2, a3); }

template<class R, class C, class A0, class A1, class A2, class A3, size_t SA>
inline void VariantCall(R (C::*f)(A0,A1,A2,A3) const, const C &o, const TVariant<SA> *va)
{ VC_ConstMemFn4<R,C,A0,A1,A2,A3,4,SA,SA,SA,SA>()(f, o, va[0], va[1], va[2], va[3]); }
